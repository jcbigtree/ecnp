"""Function optimization using differential evolution.

Minimize real-value single-objective functions using differential evolution.
"""
...
def minimize(function, runs):
    ...
    for run in range(runs):
        ...
        my_de = DifferentialEvolution()
        my_de.evolve(max_gen=200, 
        ...
        elite_fitness_runs.append(np.array(my_de.staged_best_fitness_))
